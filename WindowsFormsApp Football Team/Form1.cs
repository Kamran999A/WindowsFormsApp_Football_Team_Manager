...
namespace WindowsFormsApp_Football_Team
{
    public partial class Form1 : Form
    {
        ...
        private void PositionNameLbl_Click(object sender, EventArgs e)
        {
        ...
        private void PlayerNumberLbl_Click(object sender, EventArgs e)
        {

        }

        private void PlayerNameLbl_Click(object sender, EventArgs e)
        {
